...
export const pedroWerlangData: DNAGenisAnalysis = {
  meta: {
    versao: '1.0-supremo',
  ...
  plano_acao: {
    ...
    desafio_mes: {
      ...
      descricao:
        'Gravar pitch 3min + Q&A 4min. Medir: vícios no pitch (<3), vícios no Q&A (<5), modulação em dados, postura ao apontar. Meta: redução de 50% nos vícios vs baseline.',
    },
  },
