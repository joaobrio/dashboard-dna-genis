...
export function DashboardShell({ data, userName, analysisDate }: DashboardShellProps) {
      ...
      <header className="border-b border-white/10 backdrop-blur-xl bg-white/5 sticky top-0 z-50">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-genis-yellow/20 backdrop-blur-sm border border-genis-yellow/30 flex items-center justify-center">
            ...
            >
              <div className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl border border-white/15 bg-white/5 backdrop-blur-md shadow-sm">
                <div className="flex flex-col leading-tight">
                  ...
                  {analysisDate && <p className="text-xs text-gray-400">{analysisDate}</p>}
                </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-6 border-t border-white/10">
                  <p className="text-sm text-gray-400 mb-2">Autoconfiança</p>
            ...
            <div className="space-y-4">
              {data.indicadores
                ...
                .map((ind, index) => (
                  <div
                    key={ind.codigo}
                    className="flex items-center justify-between p-4 bg-green-500/10 rounded-xl border border-green-500/20 hover:border-green-400/40 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">{ind.pilar}</p>
                      </div>
                    </div>
            ...
            <div className="space-y-4">
              {data.indicadores
                ...
                .map((ind, index) => (
                  <div
                    key={ind.codigo}
                    className="flex items-center justify-between p-4 bg-orange-500/10 rounded-xl border border-orange-500/20 hover:border-orange-400/40 transition-colors"
                  >
                    <div className="flex items-center gap-3">
